...
import AvatarHeader from './header_avatar';
import NavHeader from './header_nav';
import SobreMim from './header_sobremim';
...
class Header extends Component{
  ...
  constructor(props){
    ...
    let selectedTheme = arrayTheme[Math.floor(Math.random()*arrayTheme.length)];
    
    this.changeHeaderTheme = () => {
      let selectedTheme = arrayTheme[Math.floor(Math.random()*arrayTheme.length)];
      this.setState({ headerTheme: {
          ...
          <div className="container bigpadd header">
            ...
            <div className="block">
              <div className="flex-center nowrap">
                <AvatarHeader/>
                <SobreMim />
                <Button className="bt_header_theme" onClick={this.changeHeaderTheme} >
                  Alterar tema
                </Button>
              </div>
            </div>
