...
class Footer extends Component{
  ...
  render(){
    return (
      <footer>
        <Button variant="contained" onClick={this.webAPIshare} style={
          {background: "#363636"}
        }><i className="fas fa-share-alt"></i>&nbsp;Compartilhar</Button>
        <sub>Funciona em <i className="fab fa-chrome"></i> Google Chrome</sub>
        <sub><i className="far fa-eye"></i> {this.state.views} visualizações</sub>
