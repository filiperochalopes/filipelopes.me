...
import CurriculoHeader from '../components/curriculo_header';
      ...
      <React.Fragment>
        <section>
          ...
          <div className="container">
            <h1><Link to="/curriculo">Currículo <i className="fas fa-external-link-alt"></i></Link> 
            ...
            <h2>Resumo</h2>
              <section id="curriculo_resumo">
                ...
                <div className="texto">
                  <p>Primeiramente discípulo de Jesus, graduando em medicina na Universidade Federal da Bahia. Atualmente cursando o 9º semestre. Trabalho com criação de sites e sistemas web com planejamento de expansão para aplicativos móveis e aplicações com <em>Deep learning</em> para integração.</p>
                  <p>Trabalhando atualmente em paralelo nessas duas áreas. Abaixo você verá a listagem de algumas de minhas habilidades e nível de aprofundamento nelas, sinta-se livre para clicar e explorar, ainda vem mais por aí.</p>
                </div>
              </section>
              <p></p>
            <h2>Habilidades</h2>
            ...
            <ul id="skill_list">
              <Skill
                ...
                skills={
                  [["Modelagem", 90], ["Texturização", 50], ["Animação", 45]]
                }
                xp={"2 anos"}
                courses={
                  [["auto de data", ""]]
            ...
            <ul id="skill_list">
              ...
              <Skill
                ...
                skills={
                  [["Flask", 80], ["Machine learning", 0], ["Blender", 0]]
                }>Python</Skill>
              <Skill
                ...
                skills={
                  [["JQuery", 80], ["ReactJS", 30], ["ReactNative", 0], ["Blend4Web", 70]]
                }>Javascript</Skill>
              <Skill
                className="css3"
                percent={98}
            ...
            <ul id="skill_list">
              ...
              <Skill
                ...
                courses={
                  [
                    ["CCAA Júnior", ""],
                    ["Núcleo de Extensão em Linguagens?", "/titulo/nupel", "2 anos"]
                  ]
                }>Inglês</Skill>
              <Skill
                className="libras"
                ...
                }>Língua Brasileira de Sinais (LIBRAS)</Skill>
            </ul>
